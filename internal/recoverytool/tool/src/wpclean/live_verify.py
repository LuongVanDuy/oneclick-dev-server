...
from .windows_paths import runtime_temporary_directory
...
def _hash_remote_files(
    ...
    *,
    ...
    with runtime_temporary_directory(prefix="wpclean-live-core-") as temp_dir:
...
def verify_live_site(
    *,
    ...
    scanned = 0
    with runtime_temporary_directory(prefix="wpclean-live-scan-") as temp_dir:
